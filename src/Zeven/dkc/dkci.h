...
DLL_API(int32_t)			dkcGetFrame(); // Pour obtenir le nb de frame o on est rendu
...
DLL_API(int32_t)			dkcUpdateTimer(); // Will return the current frame count
DLL_API(void)			dkcSleep(int32_t ms);
