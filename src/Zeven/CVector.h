...
///
/// \file CVector.h
/// Pour dêinir un vecteur en 2D ou en 3D ainsi que ses operateurs
/// Ici ce n'est pas juste pour les vecteurs mais aussi des maths en gêêal
///
/// \author David St-Louis (alias Daivuk)
/// \author Louis Poirier (êdes fins de documentation seulement)
//*******************************************************************
...
#define cVector CVector3f // Pour les anciennes compatibilitê
#define CVector CVector3f // Pour les anciennes compatibilitê
//@}
