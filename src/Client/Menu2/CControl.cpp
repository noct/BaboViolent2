...
void CControl::render()
{
    ...
    if(!text.isNull() || !isNull() || haveFocus())
    {
        ...
        case CONTROL_TEXTALIGN_TOPLEFT:
            printLeftText((float)pos[0] + 3 + offsetText[0], (float)pos[1] + 3 + offsetText[1], textSize, enableShadow, _text);
            break;
        case CONTROL_TEXTALIGN_TOPCENTER:
            printCenterText((float)pos[0] + (float)size[0] / 2 + offsetText[0], (float)pos[1] + 3 + offsetText[1], textSize, enableShadow, _text);
            break;
        case CONTROL_TEXTALIGN_TOPRIGHT:
            printRightText((float)pos[0] + (float)size[0] - 3 + offsetText[0], (float)pos[1] + 3 + offsetText[1], textSize, enableShadow, _text);
            break;
        case CONTROL_TEXTALIGN_MIDDLELEFT:
            printLeftText((float)pos[0] + 3 + offsetText[0], (float)pos[1] + (float)size[1] / 2 - ((float)textSize / 2) + offsetText[1], textSize, enableShadow, _text);
            break;
        case CONTROL_TEXTALIGN_MIDDLECENTER:
            printCenterText((float)pos[0] + (float)size[0] / 2 + offsetText[0], (float)pos[1] + (float)size[1] / 2 - ((float)textSize / 2) + offsetText[1], textSize, enableShadow, _text);
            break;
        case CONTROL_TEXTALIGN_MIDDLERIGHT:
            printRightText((float)pos[0] + (float)size[0] - 3 + offsetText[0], (float)pos[1] + (float)size[1] / 2 - ((float)textSize / 2) + offsetText[1], textSize, enableShadow, _text);
            break;
        case CONTROL_TEXTALIGN_BOTTOMLEFT:
            printLeftText((float)pos[0] + 3 + offsetText[0], (float)pos[1] - textSize - 3 + (float)size[1] + offsetText[1], textSize, enableShadow, _text);
            break;
        case CONTROL_TEXTALIGN_BOTTOMCENTER:
            printCenterText((float)pos[0] + (float)size[0] / 2 + offsetText[0], (float)pos[1] - textSize - 3 + (float)size[1] + offsetText[1], textSize, enableShadow, _text);
            break;
        case CONTROL_TEXTALIGN_BOTTOMRIGHT:
            printRightText((float)pos[0] + (float)size[0] - 3 + offsetText[0], (float)pos[1] - textSize - 3 + (float)size[1] + offsetText[1], textSize, enableShadow, _text);
            break;
        }
        ...
        if(haveFocus() && m_cursorAnim < .5f)
        {
            ...
            {
            case CONTROL_TEXTALIGN_TOPLEFT:
                printLeftText(posX + (float)pos[0] + 3 + offsetText[0], (float)pos[1] + 3 + offsetText[1], textSize, enableShadow, _text);
                break;
            case CONTROL_TEXTALIGN_TOPCENTER:
                printCenterText(posX + (float)pos[0] + (float)size[0] / 2 + offsetText[0], (float)pos[1] + 3 + offsetText[1], textSize, enableShadow, _text);
                break;
            case CONTROL_TEXTALIGN_TOPRIGHT:
                printRightText(posX + (float)pos[0] + (float)size[0] - 3 + offsetText[0], (float)pos[1] + 3 + offsetText[1], textSize, enableShadow, _text);
                break;
            case CONTROL_TEXTALIGN_MIDDLELEFT:
                printLeftText(posX + (float)pos[0] + 3 + offsetText[0], (float)pos[1] + (float)size[1] / 2 - ((float)textSize / 2) + offsetText[1], textSize, enableShadow, _text);
                break;
            case CONTROL_TEXTALIGN_MIDDLECENTER:
                printCenterText(posX + (float)pos[0] + (float)size[0] / 2 + offsetText[0], (float)pos[1] + (float)size[1] / 2 - ((float)textSize / 2) + offsetText[1], textSize, enableShadow, _text);
                break;
            case CONTROL_TEXTALIGN_MIDDLERIGHT:
                printRightText(posX + (float)pos[0] + (float)size[0] - 3 + offsetText[0], (float)pos[1] + (float)size[1] / 2 - ((float)textSize / 2) + offsetText[1], textSize, enableShadow, _text);
                break;
            case CONTROL_TEXTALIGN_BOTTOMLEFT:
                printLeftText(posX + (float)pos[0] + 3 + offsetText[0], (float)pos[1] - textSize - 3 + (float)size[1] + offsetText[1], textSize, enableShadow, _text);
                break;
            case CONTROL_TEXTALIGN_BOTTOMCENTER:
                printCenterText(posX + (float)pos[0] + (float)size[0] / 2 + offsetText[0], (float)pos[1] - textSize - 3 + (float)size[1] + offsetText[1], textSize, enableShadow, _text);
                break;
            case CONTROL_TEXTALIGN_BOTTOMRIGHT:
                printRightText(posX + (float)pos[0] + (float)size[0] - 3 + offsetText[0], (float)pos[1] - textSize - 3 + (float)size[1] + offsetText[1], textSize, enableShadow, _text);
                break;
            }
        }
